...
> 日期：2026-06-10（页眉检测+NFKC纠偏） · 来源：`scripts/eval/compare_docling.py` · 数据：Docling 自带 born-digital 测试集（tmp/refer/docling/tests/data，其 groundtruth = Docling 自身输出）
...
| 文档 | NID | TEDS | MHS | 备注 |
|---|---|---|---|---|
| 2203.01017v2 | 0.927 | 0.246 | 0.652 | 表格 我方4/Docling6 |
| 2206.01062 | 0.814 | 0.365 | 0.462 | 表格 我方6/Docling5 |
| 2305.03393v1-pg9 | 0.871 | 0.060 | 1.000 | 表格 我方1/Docling1 |
| 2305.03393v1 | 0.918 | 0.088 | 0.857 | 表格 我方2/Docling2 |
...
| redp5110_sampled | 0.735 | 0.365 | 0.479 | 表格 我方5/Docling6 |
...
| 切片 | 文档数 | NID | TEDS | MHS |
|---|---|---|---|---|
| **born-digital LTR**（去 RTL）| 10 | **0.833** | — | **0.645** |
| 含表格子集（TEDS 仅在有表文档有意义）| 6 | — | **0.187** | — |
| RTL（超范围，仅记录）| 3 | 0.016 | — | — |
