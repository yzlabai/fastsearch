...
| 文档 | NID | TEDS | MHS | 备注 |
|---|---|---|---|---|
| 2203.01017v2 | 0.418 | 0.043 | 0.080 | 表格 我方3/Docling6 |
| 2206.01062 | 0.348 | 0.092 | 0.000 | 表格 我方3/Docling5 |
| 2305.03393v1-pg9 | 0.768 | 0.000 | 0.000 | 表格 我方0/Docling1 |
| 2305.03393v1 | 0.768 | 0.000 | 0.000 | 表格 我方0/Docling2 |
| amt_handbook_sample | 0.526 | 1.000 | 0.000 |  |
| code_and_formula | 0.915 | 1.000 | 1.000 |  |
| multi_page | 0.568 | 1.000 | 0.000 |  |
| normal_4pages | 0.463 | 0.000 | 0.000 | 表格 我方0/Docling1 |
| picture_classification | 0.590 | 1.000 | 1.000 |  |
| redp5110_sampled | 0.643 | 0.034 | 0.491 | 表格 我方4/Docling6 |
| right_to_left_01 | 0.019 | 1.000 | 0.000 | RTL（我方 LTR，超范围） |
...
| 切片 | 文档数 | NID | TEDS | MHS |
|---|---|---|---|---|
| **born-digital LTR**（去 RTL）| 10 | **0.601** | — | **0.257** |
