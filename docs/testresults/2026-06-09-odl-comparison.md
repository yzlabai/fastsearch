...
> 日期：2026-06-10（chunk 栏序修复后） · 来源：`scripts/eval/compare_odl.py` · 参照：ODL JSON 输出（/tmp/odl_out）

> ODL 是**确定性**结构抽取器（Java/veraPDF wcag-algs），与本项目同类——其水平**确定性可达**。NID=阅读顺序(词级)，TEDS=表格结构代理，MHS=标题文本集 F1。

| 文档 | NID | TEDS | MHS | 备注 |
|---|---|---|---|---|
| 2203.01017v2 | 0.936 | 0.008 | 0.652 | 表 我方4/ODL13 |
| 2206.01062 | 0.748 | 0.036 | 0.293 | 表 我方6/ODL10 |
| 2305.03393v1-pg9 | 0.990 | 0.060 | 1.000 | 表 我方1/ODL1 |
| 2305.03393v1 | 0.921 | 0.023 | 0.488 | 表 我方2/ODL12 |
...
| redp5110_sampled | 0.973 | 0.184 | 0.410 | 表 我方5/ODL4 |
| right_to_left_01 | 0.971 | 1.000 | 1.000 | RTL |
| right_to_left_02 | 0.000 | 0.000 | 0.000 | RTL |
| right_to_left_03 | 0.000 | 0.000 | 0.000 | RTL |
