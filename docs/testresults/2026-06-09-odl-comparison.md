...
> 日期：2026-06-10（页眉检测+NFKC纠偏） · 来源：`scripts/eval/compare_odl.py` · 参照：ODL JSON 输出（/tmp/odl_out）

> ODL 是**确定性**结构抽取器（Java/veraPDF wcag-algs），与本项目同类——其水平**确定性可达**。NID=阅读顺序(词级)，TEDS=表格结构代理，MHS=标题文本集 F1。

| 文档 | NID | TEDS | MHS | 备注 |
|---|---|---|---|---|
| 2203.01017v2 | 0.945 | 0.091 | 0.652 | 表 我方4/ODL13 |
| 2206.01062 | 0.748 | 0.062 | 0.293 | 表 我方6/ODL10 |
| 2305.03393v1-pg9 | 1.000 | 0.060 | 1.000 | 表 我方1/ODL1 |
| 2305.03393v1 | 0.939 | 0.044 | 0.647 | 表 我方2/ODL12 |
