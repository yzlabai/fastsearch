...
战略见 [docs/roadmap.md](docs/roadmap.md)；执行里程碑 M1–M7 见 [docs/plans/beating-docling.md](docs/plans/beating-docling.md)；战术清单见 [docs/iteration-guide.md §5](docs/iteration-guide.md)。**M1–M5 已完成**（2026-06-09，见 docs/devlogs/）：文本保真、IR 脊梁、版面可读、有框表格、多格式（PDF/DOCX/HTML）。当前进行中：**M6 RAG 切块 + chunk↔bbox 双向引用**。
