...
战略见 [docs/roadmap.md](docs/roadmap.md)；执行里程碑 M1–M7 见 [docs/plans/beating-docling.md](docs/plans/beating-docling.md)；战术清单见 [docs/iteration-guide.md §5](docs/iteration-guide.md)。当前进行中：**M2 IR 脊梁**（版本化 + provenance + 质量评分骨架）。M1 文本保真（标准14 AFM 度量 + Encoding/Differences/AGL + `Tc`/`Tw`/`Tz`，修复连字丢失）已于 2026-06-09 完成。
