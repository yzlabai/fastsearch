...
- [ ] Long tail: human-labeled ground truth (agreement → accuracy), OCR extras (orientation cls / JBIG2-CCITT / form streams), PPTX/XLSX backends, same-machine throughput benchmarks.
